...
match opcao:
    ...
    case 2:
        ...
        problema = str(input("Por favor relate o problema com seu veiculo: "))
        print(f"registrando o seu problema ({problema})...")
        time.sleep(2)
        ...
        print(f"""
                ...
                ---------------------------------------
                Foi constatado que o veículo apresenta \n
                o problema {problema}.
                """)
